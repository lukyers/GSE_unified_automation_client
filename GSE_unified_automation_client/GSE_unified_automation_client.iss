...
#define MyAppPath "C:\Users\zhangr32\Desktop\GSE_unified_automation_client"
...
Source: "InstallerIcon.ico"; DestDir: "{app}"; Flags: dontcopy
Source: "GetRemoteDir.ps1"; DestDir: "{app}"; Flags: ignoreversion 64bit; Permissions: users-full; Check: IsWin64
Source: "UninstallIcon.ico"; DestDir: "{app}"; Flags: dontcopy
Source: "Install.cmd"; DestDir: "{app}"; Flags: ignoreversion 64bit; Permissions: users-full; Check: IsWin64
Source: "ClientScript.ps1"; DestDir: "{app}"; Flags: ignoreversion 64bit; Permissions: users-full; Check: IsWin64
Source: "a.bmp"; DestDir: "{app}"; Flags: dontcopy
...
[Run]
Filename: "powershell.exe"; Description: Run Auto Deployment; Parameters: "/c & .\{#MyAppExeName}"; WorkingDir: "{app}"; Flags: 64bit postinstall skipifsilent waituntilterminated
Filename: "powershell.exe"; Description: Run Service; Parameters: "/c & .\ClientScript.ps1"; WorkingDir: "{app}"; Flags: 64bit postinstall skipifsilent waituntilterminated
...
begin
  ...
  BackgroundBitmapImage.BackColor := clGray;
  BackgroundBitmapImage.Align := alCLient;
  BackgroundBitmapImage.Bitmap.LoadFromFile('a.bmp');
...
var
  python, ipython, DLL : String;

begin
  ipython := 'C:\Program Files (x86)\IronPython 2.7';
  python := 'C:\Python27';
  DLL := 'C:\DLL';
  if DirExists(ipython) then
    RemoveDir(ipython);
  if DirExists(python) then
    RemoveDir(python);
  if DirExists(DLL) then
    RemoveDir(DLL); 
end;